...
import static by.itstep.stpnbelko.homework.stage14.model.logic.LevelALogic.findNotZero;
...
public class LevelA {
    public static void main(String[] args) {
        ...
        String msg = String.format("how much non-zero elements are in the array? - %d", findNotZero(array));
        print(msg);
    }
}
